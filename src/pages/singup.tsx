...
const SignUp: React.FC = () => {
    return (
        <div className='flex gap-x-36 gap-y-16 flex-col lg:flex-row items-center px-8 lg:px-48 pt-24 lg:pt-0 min-h-screen lg:h-screen'>
            <div className='flex-auto'>
                <img src={logo} alt='Logo' />
            </div>
            <div className='flex-auto lg:bg-custom-gradient lg:py-6 lg:pr-7 lg:pl-8 w-full rounded-xl'>
                <div className='text-3xl lg:text-5xl text-center'>Sign Up</div>
                ...
                <div className='mt-4 lg:mt-5 text-base lg:text-2xl lg:text-nowrap flex'>
                    <CheckBoxCom text='Accept Our Terms & Conditions' />
                    <div className='text-donaut'>Read</div>
                </div>
                <div className='mt-5'>
                    <ButtonCom bgColor='donaut' text='Sign Up'/>
                </div>
                ...
                <div className='mt-6 text-center text-base lg:text-2xl '>
                    Already have an Account Yet? <span className='text-donaut'>Sign Up</span>
                </div>
            </div>
        </div>
    );
