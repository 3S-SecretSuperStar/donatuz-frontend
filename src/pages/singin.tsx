    ...
    return (
        <div className='flex gap-x-36 gap-y-16 flex-col lg:flex-row items-center justify-center px-8 lg:pt-0 md:px-24 lg:px-48 pt-24 min-h-screen pb-5'>
            ...
            <div className='basis-2/5 lg:bg-custom-gradient lg:py-6 lg:pr-7 lg:pl-8 w-full rounded-xl lg:shadow-lg block'>
                <div className='text-3xl lg:text-3xl text-center'>Sign In</div>
                <div className='text-xs lg:text-sm mt-3 text-center'>login to manage your content, engage with your community, and monetize</div>
                ...
                <div className='mt-3'>
                    <ButtonCom bgColor='bg-donaut' text='Sign In'/>
                </div>
                ...
                <div className='mt-3 text-center text-base lg:text-1xl p-3 lg:p-0 rounded-md lg:rounded-none'>
